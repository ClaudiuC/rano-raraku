-- This is just a rename of https://github.com/kikito/middleclass
...
function RRClass.class(name, super, ...)
  super = super or Object
  return super:subclass(name, ...)
end

RRClass.Object = Object

setmetatable(RRClass, { __call = function(_, ...) return RRClass.class(...) end })
